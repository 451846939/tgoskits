...
impl RgaFile {
    ...
    fn handle_blit_sync(&self, current: &UserTaskRef, arg: usize) -> VfsResult<usize> {
    ...
    fn handle_import_buffer(&self, current: &UserTaskRef, arg: usize) -> VfsResult<usize> {
    ...
    fn handle_release_buffer(&self, current: &UserTaskRef, arg: usize) -> VfsResult<usize> {
        let pool: librga_abi::RgaBufferPool = unsafe {
            (arg as *const librga_abi::RgaBufferPool)
                .vm_read_uninit(current)?
                .assume_init()
    ...
    fn handle_get_driver_version(&self, current: &UserTaskRef, arg: usize) -> VfsResult<usize> {
    ...
    fn handle_get_hw_version(&self, current: &UserTaskRef, arg: usize) -> VfsResult<usize> {
    ...
    fn handle_request_create(&self, current: &UserTaskRef, arg: usize) -> VfsResult<usize> {
    ...
    ) -> VfsResult<Vec<librga_abi::RgaReq>> {
    ...
    fn handle_request_config(&self, current: &UserTaskRef, arg: usize) -> VfsResult<usize> {
    ...
    fn handle_request_submit(&self, current: &UserTaskRef, arg: usize) -> VfsResult<usize> {
        let ureq: librga_abi::RgaUserRequest = unsafe {
            (arg as *const librga_abi::RgaUserRequest)
                .vm_read_uninit(current)?
                .assume_init()
    ...
    fn handle_request_cancel(&self, current: &UserTaskRef, arg: usize) -> VfsResult<usize> {
