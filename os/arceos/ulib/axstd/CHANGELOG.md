...
## [0.5.31](https://github.com/rcore-os/tgoskits/compare/ax-std-v0.5.30...ax-std-v0.5.31) - 2026-08-04

### Other

- updated the following local packages: ax-task, ax-hal, ax-runtime, ax-api, ax-posix-api
